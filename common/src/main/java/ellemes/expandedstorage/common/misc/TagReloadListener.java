...
public class TagReloadListener {
    ...
    public static final TagKey<EntityType<?>> minecartChestCycle = TagKey.create(Registry.ENTITY_TYPE_REGISTRY, Utils.id("minecart_chest_cycle"));
    ...
    public void postDataReload() {
        ...
        minecartChestCycleEntityTypes = Registry.ENTITY_TYPE.getOrCreateTag(minecartChestCycle).stream().map(Holder::value).toList();
    }
