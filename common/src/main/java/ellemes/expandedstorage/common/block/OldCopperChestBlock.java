...
public class OldCopperChestBlock extends AbstractChestBlock implements WeatheringCopper {
    private final WeatherState weatherState;

    public OldCopperChestBlock(Properties settings, ResourceLocation blockId, ResourceLocation openingStat, int slotCount, WeatheringCopper.WeatherState weatherState) {
