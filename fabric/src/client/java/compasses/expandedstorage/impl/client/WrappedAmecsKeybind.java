...
public class WrappedAmecsKeybind implements Keybinding {
    private final KeyMapping binding = KeyBindingHelper.registerKeyBinding(new AmecsKeyBinding(Utils.id("open_config_screen"), InputConstants.Type.KEYSYM, KEY_BIND_KEY, KeyMapping.CATEGORY_INVENTORY, new KeyModifiers().setShift(true)));
