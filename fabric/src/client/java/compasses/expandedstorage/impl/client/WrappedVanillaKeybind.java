...
public class WrappedVanillaKeybind implements Keybinding {
    private final KeyMapping binding = KeyBindingHelper.registerKeyBinding(new KeyMapping("key.expandedstorage.open_config_screen", Utils.KEY_BIND_KEY, "key.categories.inventory"));
