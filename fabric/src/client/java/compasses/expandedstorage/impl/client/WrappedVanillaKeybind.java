...
public class WrappedVanillaKeybind implements Keybinding {
    private final KeyMapping binding = KeyBindingHelper.registerKeyBinding(new KeyMapping("key.expandedstorage.open_config_screen", KEY_BIND_KEY, KeyMapping.CATEGORY_INVENTORY));
