...
public class RecipeProvider extends FabricRecipeProvider {
    ...
    protected void generateRecipes(Consumer<FinishedRecipe> exporter) {
        var recipeHelper = new RecipeHelper(
                ...
                ThreadTags.Items.COPPER_INGOTS, ThreadTags.Items.IRON_INGOTS, ThreadTags.Items.GOLD_INGOTS, ThreadTags.Items.DIAMONDS, ThreadTags.Items.OBSIDIAN, ThreadTags.Items.NETHERITE_INGOTS,
